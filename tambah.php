...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $jumlah_uang  = !empty($_POST['jumlah_uang'])  ? (float) $_POST['jumlah_uang']  : 0;
    $jumlah_beras = !empty($_POST['jumlah_beras']) ? (float) $_POST['jumlah_beras'] : 0;
    ...
    mysqli_stmt_bind_param($stmt, "ssddsss",
        $nama, $jenis, $jumlah_uang, $jumlah_beras, $metode, $tanggal, $keterangan
    );

    // ✅ TAMBAHKAN DI SINI, setelah bind_param, sebelum tutup kurung kurawal else
